public class Main {
    public static void main(String[] args) {
        ...
        gryffindor1.compare(slytherin1);
        gryffindor1.compare(gryffindor2);
        slytherin1.compare(slytherin2);
        hufflepuff1.compare(hufflepuff2);
        ravenclaw1.compare(ravenclaw2);
